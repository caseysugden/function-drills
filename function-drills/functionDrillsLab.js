...
function makeSavingsAccountCroak(gold) {
  return gold / 3;
}

let totalFrogs = makeSavingsAccountCroak(100);
...
function makeSavingsAccountCroak2(gold) {
  return (gold - (gold % 3)) / 3;
}

totalFrogs = makeSavingsAccountCroak2(100);
console.log(totalFrogs);
...
function checkArrayIsAscending(array) {
...
let arrayIsAscending = checkArrayIsAscending(sampleArray);
